    ...
    <header className="bg-gradient-to-r from-slate-900 to-slate-800 text-white px-4 lg:px-8 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 bg-sky-500 rounded-full flex items-center justify-center shrink-0 shadow-lg shadow-sky-500/30">
          ...
          <div className="hidden sm:block">
            ...
            <p className="text-[11px] text-sky-300 font-semibold uppercase tracking-wider">
              Animateur de Pôle
            </p>
          </div>
        </div>

        {/* Centre — Navigation AP */}
        <nav className="hidden md:flex items-center gap-1">
          <NavLink
            to="/member/ap/dashboard"
