# core/migrations/0007_seed_departments_associations.py
...
def seed_forward(apps, schema_editor):
    ...
    for code, name in ASSOCIATIONS:
        Association.objects.get_or_create(code=code, defaults={'name': name, 'is_active': True})


def seed_reverse(apps, schema_editor):
    # Do not delete departments/associations on reverse — they may have been added before
    pass
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0006_add_etablissement_financement_refonte'),
    ]
