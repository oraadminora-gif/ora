...
from .mentorat_acceptance import PublicMentoratAcceptanceView
...
urlpatterns = [
    ...
    path('accepter-mentorat/<str:token>/', PublicMentoratAcceptanceView.as_view(), name='public-accepter-mentorat'),
